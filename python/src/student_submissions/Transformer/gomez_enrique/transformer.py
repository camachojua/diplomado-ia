...
x = PositionalEmbedding(sequence_length, vocab_size, embed_dim, trainable=True)(
    encoder_inputs
)
...
# csv logger callback
csv_logger = CSVLogger("transformer.training.log")

# model checkpoint callback
model_checkpoint = ModelCheckpoint(
    filepath="transformer.checkpoint.keras",
